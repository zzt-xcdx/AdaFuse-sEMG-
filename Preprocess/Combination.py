...
if __name__ == '__main__':
    for j in range(1, 2):
        ...
        # 滑动窗口分割
        x_train, y_train, r_train = nf.windowing(df, reps=train_reps, gestures=gestures, win_len=400, win_stride=80)
        x_test, y_test, r_test = nf.windowing(df, reps=test_reps, gestures=gestures, win_len=400, win_stride=80)
